                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="flex h-12 w-full rounded-md border px-3 bg-white text-black dark:bg-background dark:text-foreground dark:border-gray-700"
                    >
                      <option value="" className="bg-white text-black dark:bg-background dark:text-foreground">
                        Select an option
                      </option>
                      <option className="bg-white text-black dark:bg-background dark:text-foreground">
                        Executive Search
                      </option>
                      <option className="bg-white text-black dark:bg-background dark:text-foreground">
                        Board Services
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full rounded-md border px-3 py-3 bg-white text-black dark:bg-background dark:text-foreground dark:border-gray-700"
